...
export default function About() {
  return (
    <div style={{ backgroundColor: '#121212', color: '#f9f9f9', overflowX: 'hidden' }}>

      {/* 1. HERO SECTION — même structure/comportement que Home (min-height 90vh, fond fixe/parallax au scroll) */}
      <section style={{
        position: 'relative',
        minHeight: '90vh',
        display: 'flex',
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div style={{ maxWidth: '750px' }}>
            <div style={{
              ...
              <i className="bi bi-stars" style={{ fontSize: '16px' }}></i> L'Art de la Haute Gastronomie
            </div>
            ...
            <h1 style={{
              ...
              Notre <span style={{ color: '#dfb15b', fontStyle: 'italic' }}>Passion</span> pour le Goût
            </h1>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '12px', color: '#dddddd' }}>
                <li style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <i className="bi bi-fire" style={{ fontSize: '18px', color: '#dfb15b' }}></i> Cuissons maîtrisées au feu de bois
                </li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <i className="bi bi-leaf" style={{ fontSize: '18px', color: '#dfb15b' }}></i> Épices bios récoltées à la main
                </li>
                <li style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  <i className="bi bi-award" style={{ fontSize: '18px', color: '#dfb15b' }}></i> Carte renouvelée à chaque saison
                </li>
              </ul>
            </div>
        ...
        <section style={{ padding: '60px 0 90px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '25px' }}>
            ...
            <div style={{ backgroundColor: '#1a1a1a', padding: '30px', borderRadius: '12px', border: '1px solid #2a2a2a', transition: 'transform 0.3s ease' }}>
              <div style={{ color: '#dfb15b', marginBottom: '15px' }}><i className="bi bi-leaf" style={{ fontSize: '32px' }}></i></div>
            ...
            <div style={{ backgroundColor: '#1a1a1a', padding: '30px', borderRadius: '12px', border: '1px solid #2a2a2a' }}>
              <div style={{ color: '#dfb15b', marginBottom: '15px' }}><i className="bi bi-shield-check" style={{ fontSize: '32px' }}></i></div>
            ...
            <div style={{ backgroundColor: '#1a1a1a', padding: '30px', borderRadius: '12px', border: '1px solid #2a2a2a' }}>
              <div style={{ color: '#dfb15b', marginBottom: '15px' }}><i className="bi bi-heart-fill" style={{ fontSize: '32px' }}></i></div>
